function [LTM, LTM_all_ep, actual_LTM, forward_blocked, episode_steps, position_stat, time_stat_action, time_stat_episode] = NSMTrial(gazebo, robot, episodes_numof)
...
for eidx = 1:episodes_numof
    ...
    [steps_numof episode actual_episode pos_stat t_stat_action t_stat_episode blocked] = NSMEpisode(gazebo, robot, LTM);
